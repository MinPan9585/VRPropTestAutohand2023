...
Shader "b_mr_Solar system_Earth"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Fresnel_Color("Fresnel_Color", Color) = (0,0,0,0)
		_Fresnel("Fresnel", Vector) = (0,0,0,0)
		[ASEEnd]_earth("earth", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fresnelNode15 = ( _Fresnel.x + _Fresnel.y * pow( 1.0 - fresnelNdotV15, _Fresnel.z ) );
				float2 uv_earth = IN.ase_texcoord7.xy * _earth_ST.xy + _earth_ST.zw;
				float4 temp_output_18_0 = ( ( fresnelNode15 * _Fresnel_Color ) + tex2D( _earth, uv_earth ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNode15 = ( _Fresnel.x + _Fresnel.y * pow( 1.0 - fresnelNdotV15, _Fresnel.z ) );
				float2 uv_earth = IN.ase_texcoord3.xy * _earth_ST.xy + _earth_ST.zw;
				float4 temp_output_18_0 = ( ( fresnelNode15 * _Fresnel_Color ) + tex2D( _earth, uv_earth ) );
...
ASEEND*/
//CHKSM=64BA0DD285ECA6B74F2F8F89C1CEE03212653CC5